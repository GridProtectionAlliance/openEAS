...
namespace WixFolderGen
{
    class Solution
    {
        ...
        public Solution(string projectName, string rootFolderName, string applicationFolder, string fileNamePostfix)
        {
            ...
            WebFeaturesDestinationFile = "..\\..\\..\\..\\..\\Source\\Applications\\openEASSetup\\WebFeatures" + fileNamePostfix +".wxi";
            WebFoldersDestinationFile = "..\\..\\..\\..\\..\\Source\\Applications\\openEASSetup\\WebFolders" + fileNamePostfix + ".wxi";
            WebFilesDestinationFile = "..\\..\\..\\..\\..\\Source\\Applications\\openEASSetup\\WebFiles" + fileNamePostfix + ".wxi";
        }
    ...
    class Program
    {
        static void Main()
        {
            ...
            {
                new Solution("openEAS", "wwwroot", "Applications\\openEAS", "")
